...
import { StyleSheet, View, Text, ScrollView, Image, TouchableOpacity,PermissionsAndroid } from 'react-native';
    ...
    const ButtonLabelLabReport = (props) => {
        ...
        return (
            <View style={{
                ...
                {showLabImage ? <TouchableOpacity onPress={props.onPress}
                    style={{ width: '40%', borderRadius: 5, justifyContent: 'center', height: 35, alignItems: 'center', backgroundColor: theme.colors.primary }}>
                    <View style={{ justifyContent: 'space-around', alignSelf: 'center', flexDirection: 'row' }}>
                        ...
                        <Image style={{ height: 60, width: 60, }} resizeMode='cover' source={{ uri: labImageSrc, }} />
    ...
    const ButtonLabelTransmit = (props) => {
        ...
        return (
            <View style={{
                ...
                {showTransmit ? <TouchableOpacity onPress={props.onPress}
                    style={{ width: '40%', borderRadius: 5, justifyContent: 'center', height: 35, alignItems: 'center', backgroundColor: theme.colors.primary }}>
                    <View style={{ justifyContent: 'space-around', alignSelf: 'center', flexDirection: 'row' }}>
                        <Iconicons name='upload' size={15} color='#fff' style={{ paddingTop: 3 }} />
                        <Text style={{
                        ...
                        <Image style={{ height: 60, width: 60, }} resizeMode='cover' source={{ uri: transmitImageSrc, }} /></View></TouchableOpacity>}
            </View>
        )
    }
    ...
    const ButtonLabelWithoutGST = (props) => {
        ...
        return (
            <View style={{
                ...
                {showWithoutGst ? <TouchableOpacity onPress={props.onPress}
                    style={{ width: '40%', borderRadius: 5, justifyContent: 'center', height: 35, alignItems: 'center', backgroundColor: theme.colors.primary, }}>
                    <View style={{ justifyContent: 'space-around', alignSelf: 'center', flexDirection: 'row', }}>
                        <Iconicons name='upload' size={15} color='#fff' style={{ paddingTop: 3 }} />
                        <Text style={{
                        ...
                        <Image style={{ height: 60, width: 60, }} resizeMode='cover' source={{ uri: withoutGstImageSrc, }} /></View></TouchableOpacity>}
            </View>
        )
    }
    ...
    const ButtonLabelGST = (props) => {
        ...
        return (
            <View style={{
                ...
                {showGst ? <TouchableOpacity onPress={props.onPress}
                    style={{ width: '40%', borderRadius: 5, justifyContent: 'center', height: 35, alignItems: 'center', backgroundColor: theme.colors.primary }}>
                    <View style={{ justifyContent: 'space-around', alignSelf: 'center', flexDirection: 'row' }}>
                        <Iconicons name='upload' size={15} color='#fff' style={{ paddingTop: 3 }} />
                        <Text style={{
                ...
                <View style={{ flexDirection: 'column' }}>
                    <View style={{ flexDirection: 'row', marginTop: 10 }}>
                        <View style={{ width: '20%', alignItems: 'center' }}>
                            ...
                            <View style={styles.HeightIndicator(height, theme.colors.primary)} />
                        </View>
                        <View style={{ width: '83%', justifyContent: 'flex-start', alignItems: 'flex-start' }}>
                            ...
                            <View onLayout={onLayoutBales} style={{ width: '80%' }}>
                                <View style={{
                                    ...
                                    <View style={{ flexDirection: 'column', alignItems: 'flex-start', width: '45%' }}>
                                        <LabelProperty label='Post Bales' value={props.Props.post_bales} />
                                    </View>
                                    <View style={{ flexDirection: 'column', alignItems: 'flex-start', width: '39%' }}>
                                        <LabelProperty label='Sale Bales' value={props.Props.sell_bales} />
                                    </View>
                                </View>
                                <View style={{
                                    flexDirection: 'row', alignItems: 'center',
                                    justifyContent: 'space-between', paddingTop: 10,
                                        ...
                                        <LabelProperty label='Post Price' value={props.Props.post_price} /></View>
                                    <View style={{ flexDirection: 'column', alignItems: 'flex-start', width: '39%' }}>
                                        <LabelProperty label='Sale Price' value={props.Props.sell_price} />
                                    </View>
                                </View>
                            </View>
                        </View>
                    ...
                    <View style={{ flexDirection: 'row', }}>
                        <View style={{ width: '20%', alignItems: 'center' }}>
                            <View style={styles.ActivestepIndicator} />
                            <View style={styles.HeightIndicator(heightDeal, theme.colors.primary)} />
                        </View>
                            ...
                            <View style={{ width: '100%', }} onLayout={onLayoutDeal}>
                                <View style={{
                                    ...
                                    <View style={{ flexDirection: 'column', alignItems: 'flex-start', width: '40%', }}>
                                        <LabelProperty label='Buyer Name' value={props.Props.buyer_name} />
                                    </View>
                                    <View style={{ flexDirection: 'column', alignItems: 'flex-start', width: '45%', }}>
                                ...
                                <View style={{
                                    ...
                                    <View style={{ flexDirection: 'column', alignItems: 'flex-start', width: '47%' }}>
                                        <LabelProperty label='Payment Condition' value={props.Props.payment_condition} />
                                    </View>
                                    <View style={{ flexDirection: 'column', alignItems: 'flex-start', width: '45%' }}>
                                        <LabelProperty label='Transmit Condition' value={props.Props.transmit_condition} />
                                    </View>
                                </View>
                                <View style={{
                                    flexDirection: 'row', alignItems: 'center',
                    ...
                    <View style={{ flexDirection: 'row', }}>
                        <View style={{ width: '20%', alignItems: 'center' }}>
                            <View style={styles.ActivestepIndicator} />
                            <View style={styles.HeightIndicator(30, showLabImage ? '#d1d1d1' : theme.colors.primary)} />
                        </View>
                        <View style={{ width: '83%', justifyContent: 'flex-start', alignItems: 'flex-start' }}>
                    ...
                    <View style={{ flexDirection: 'row', }}>
                        <View style={{ width: '20%', alignItems: 'center' }}>
                            <View style={showLabImage ? { height: 20, width: 20, borderRadius: 10, backgroundColor: 'transparent',
                                borderWidth: 2, borderColor: '#d1d1d1'
                            } : styles.ActivestepIndicator} />
                            <View style={styles.HeightIndicator(heightSempling, showTransmit ? '#d1d1d1' : theme.colors.primary  )} />
                        </View>
                        <View style={{ width: '83%', justifyContent: 'flex-start', alignItems: 'flex-start' }}>
                            ...
                            <View style={{ width: '100%', }} onLayout={onLayoutSempling}>
                                {showLabImage ?
                                   ...
                                   <View>{labMimeType == "application/pdf" ? <View style={{width:60,height:60, flexDirection: 'row', alignItems: 'center',
                                   justifyContent: 'space-between', width: '80%', paddingTop: 10,}}><PDF_Icon onPress={() => viewDocument(props.Props.lab_report,props.Props.lab_report_mime)}/></View> : <View><ButtonLabelLabReport imgSrc={props.Props.lab_report} show={false} onPress={() => viewDocument(props.Props.lab_report,props.Props.lab_report_mime)}/></View>}</View>
                                }
                            </View>
                        </View>
                    </View>
                    <View style={{ flexDirection: 'row', }}>
                        <View style={{ width: '20%', alignItems: 'center' }}>
                            <View style={showTransmit ? {
                                height: 20, width: 20, borderRadius: 10, backgroundColor: 'transparent',
                                borderWidth: 2, borderColor: '#d1d1d1'
                            } : styles.ActivestepIndicator} />
                            <View style={styles.HeightIndicator(heightTransmit, showWithoutGst ? '#d1d1d1' : theme.colors.primary )} />
                        </View>
                        <View style={{ width: '83%', justifyContent: 'flex-start', alignItems: 'flex-start' }}>
                            ...
                            <View style={{ width: '100%', }} onLayout={onLayoutTransmit}>
                                {!showLabImage ? 
                                    ...
                                    <ButtonLabelTransmit show={true} onPress={() => openDocumentPicker('transmit')}/>
                                : 
                                    <View>{transmitMimeType == "application/pdf" ? <View style={{width:60,height:60, flexDirection: 'row', alignItems: 'center',
                                    justifyContent: 'space-between', width: '80%', paddingTop: 10,}}><PDF_Icon onPress={() => viewDocument(props.Props.transmit_deal,props.Props.transmit_deal_mime)}/></View> : <ButtonLabelTransmit imgSrc={props.Props.transmit_deal} show={false} onPress={() => viewDocument(props.Props.transmit_deal,props.Props.transmit_deal_mime)}/>}</View>
                                    }
                                    </View>: <View style={{opacity:0.5}}><ButtonLabelWithoutGST show={true}/></View>}
                            </View>
                        </View>
                    </View>
                    <View style={{ flexDirection: 'row', }}>
                        <View style={{ width: '20%', alignItems: 'center' }}>
                            <View style={showWithoutGst ? {
                                height: 20, width: 20, borderRadius: 10, backgroundColor: 'transparent',
                                borderWidth: 2, borderColor: '#d1d1d1'
                            } : styles.ActivestepIndicator} />
                            <View style={styles.HeightIndicator(heightWGST, showGst ? '#d1d1d1' : theme.colors.primary)} />
                        </View>
                        <View style={{ width: '83%', justifyContent: 'flex-start', alignItems: 'flex-start' }}>
                            <Text style={styles.title}>Pay without GST (Paid Receipt)</Text>
                            {!showTransmit ? <View style={{ width: '100%', }} onLayout={onLayoutWithoutGST}>
                                {showWithoutGst ?
                                    <Text style={{
                                        fontSize: 14,
                                        color: '#333',
                                    ...
                                    <View>{withoutGstMimeType == "application/pdf" ? <View style={{width:60,height:60, flexDirection: 'row', alignItems: 'center',
                                    justifyContent: 'space-between', width: '80%', paddingTop: 10,}}><PDF_Icon onPress={() => viewDocument(props.Props.without_gst,props.Props.without_gst_mime)}/></View> : <ButtonLabelWithoutGST imgSrc={props.Props.without_gst} show={false} onPress={() => viewDocument(props.Props.without_gst,props.Props.without_gst_mime)}/>}</View>
                                }
                            </View> : <View style={{ width: '100%',opacity:0.5 }} onLayout={onLayoutWithoutGST}><Text style={{
                                        fontSize: 14,
                                        color: '#333',
                                        opacity: 0.5,
                                        fontFamily: "Poppins-Regular"
                                    }}>Confirmation Needed</Text></View>}
                    ...
                    <View style={{ flexDirection: 'row', }}>
                        ...
                        <View style={{ width: '83%', justifyContent: 'flex-start', alignItems: 'flex-start' }}>
                            ...
                            {!showWithoutGst ? <View style={{ width: '100%', }}>
                                {showGst ?
                                    <Text style={{
                                        fontSize: 14,
                                        color: '#333',
                                    ...
                                    <View>{gstMimeType == "application/pdf" ? <View style={{width:60,height:60, flexDirection: 'row', alignItems: 'center',
                                    justifyContent: 'space-between', width: '80%', paddingTop: 10,}}><PDF_Icon onPress={() => viewDocument(props.Props.gst_reciept,props.Props.gst_reciept_mime)}/></View>: <ButtonLabelGST imgSrc={props.Props.gst_reciept} show={false} onPress={() => viewDocument(props.Props.gst_reciept,props.Props.gst_reciept_mime)}/> }</View>
                                }
                            </View> : <View style={{ width: '100%',opacity: 0.5 }}><Text style={{
                                        fontSize: 14,
                                        color: '#333',
                                        opacity: 0.5,
                                        fontFamily: "Poppins-Regular"
...
const styles = StyleSheet.create({
    ...
    ActivestepIndicator: {
        height: 20, width: 20, borderRadius: 10, backgroundColor: theme.colors.primary
    },
    HeightIndicator: (height, color) => ({
        height: height + 10, width: '3%', backgroundColor: color
    }),
    title: {
        color: theme.colors.textColor,
        fontSize: 16,
